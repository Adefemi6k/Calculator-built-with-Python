...
# Funtion to type into the input field
def btn_click(item):
    global expression
...
# Button First Row
clear =  Button(btns_frame, text='C', width=34,height=3, command=lambda: bt_clear()).grid(row=0, column=0, columnspan=3, padx=1, pady=1)
...
subtract = Button(btns_frame, text='-', width=10, height=3, command=lambda: btn_click('-')).grid(row=2, column=3, padx=1, pady=1)
...
one = Button(btns_frame, text='3', width=10, height=3, command=lambda: btn_click(3)).grid(row=3, column=2, padx=1, pady=1)

one = Button(btns_frame, text='+', width=10, height=3, command=lambda: btn_click('+')).grid(row=3, column=3, padx=1, pady=1)
...
equal = Button(btns_frame, text='=', width=22, height=3, command=lambda: bt_equal()).grid(row=4, column=2, columnspan=2, padx=1, pady=1)

# square_root = Button(btns_frame, text='', width=10, height=3).grid(row=4, column=2, padx=1, pady=1)
